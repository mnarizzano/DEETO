...
class AbstractWriter {
 ...
 public:
  ...
  inline const string getFilename( void ) const {return filename_;} 
  inline void setFilename(string filename){filename_ = filename;}
  inline const string getExtension( void ){return extension_;}
 ...
 protected:
  /** appends correct extension to filename depending on which subclass has been 
      istantiated*/
  //  [TO FIX] : if a file without a "." is provided, tmp is empty! 
