...
class ElectrodeTrajectoryConstructor():
    ...
    def __init__(self, nii_gz_path:str,image_intensity_threshold:float or None=None) -> None:
        '''
    ...
    def _compute_center_of_gravity(self,image:sitk.Image,cohords_offsets: tuple[int]):
        '''
    ...
    def _compute_trajectory(self,head_point:NDArray[float64],tail_point:NDArray[float64],distances:NDArray[float64],contact_len:float64,contact_radius:float64):
        """
