...
% 
% Modified by Alejandro Blenkmann
            ...
            switch(j)
                case 1 % Left list contents
                    if ~iscellstr(parVal)
                        ...
                        % Initial contents 
                        handles.leftListContents=parVal;%sort(parVal); AB 2016
                        set(handles.LeftListN,'String',int2str(length(handles.leftListContents)));
                    end
                case 2 % Right list contents
                    if ~iscellstr(parVal) && ~isempty(parVal)
                        error('The %s parameter value must be a cell array of strings or empty',parName)
                         ...
                         % Initial contents 
                         handles.rightListContents=parVal;%sort(parVal); AB 2016
                         set(handles.RightListN,'String',int2str(length(handles.rightListContents)));
                    end
                case 3 % List names
...
%AB 2016
set(handles.LeftListN,'String',int2str(length(handles.leftContents)));
set(handles.RightListN,'String',int2str(length(handles.rightContents)));
