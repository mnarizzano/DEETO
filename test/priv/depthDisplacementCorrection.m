...
distances=eucDistMat(posDepth_s,posGrid_s); %new, corrected version
...
% Taimuri's way (Most depth electrodes moving the same, including most depth ones ):
% projectionsDepth=(weights*projectionsGrid) ./ repmat(sum(weights,2),1,3); 
