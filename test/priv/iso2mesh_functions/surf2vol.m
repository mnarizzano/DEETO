...
% 
% Modified so img is a logical matrix, faster and less memory consuming.
% A Blenkmann 7 Oct 2022
...
% img=zeros(length(xi),length(yi),length(zi)); % A Blenkmann 7 Oct 2022
img=zeros(length(xi),length(yi),length(zi),'logical');
